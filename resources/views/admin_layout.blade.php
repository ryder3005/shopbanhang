      ...
      <div class="layout-container">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href={{ route('brand.all') }} class="menu-link">
                    <div data-i18n="Container">Brand</div>
                  </a>
                </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Layouts">Quản lí bán hàng</div>
              </a>
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href={{ route('discounts.all') }} class="menu-link">
                    <div data-i18n="Without navbar">Mã giảm giá </div>
                  </a>
                </li>
                {{-- <li class="menu-item">
                  <a href={{ route('brand.all') }} class="menu-link">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            @if (session('message'))
            <script>
                toastElement = document.querySelector('.bs-toast');
                toast = new bootstrap.Toast(toastElement);
                toast.show();
            </script>
              {{ session()->forget('message') }}<!-- Xóa thông điệp khỏi session -->
        @endif
