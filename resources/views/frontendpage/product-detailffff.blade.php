                                ...
                                <div class="pick-section">
                                    ...
                                    <div class="pick-options">
                                        @foreach ($StorageCapacity as $i)
                                            ...
                                            @endphp
                                            <a href="{{ route('home.detail', ['product_id' => $product->product_id, 'detail_id' => $filteredDetails->first()->ProductDetailID ?? '']) }}"
                                ...
                                <div class="pick-section">
                                    ...
                                    <div class="pick-options">
                                        @foreach ($rams as $i)
                                            @php
                                                $filteredDetails = collect($product->details)->filter(function ($detail) use ($i) {
                                                    return $detail->RAM == $i && $detail->StorageCapacity == session('SelectStorageCapacity');
                                                });
                                ...
                                <div class="pick-section">
                                    ...
                                    <div class="pick-options">
                                        @foreach ($Color as $i)
                                            @php
                                                $filteredDetails = collect($product->details)->filter(function ($detail) use ($i) {
                                                    return $detail->Color == $i && $detail->RAM == session('SelectRAM') && $detail->StorageCapacity == session('SelectStorageCapacity');
                                                });
