          ...
          <div class="authentication-inner">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <form id="formAuthentication" class="mb-3" action={{ route('user.forgetverification') }} method="POST">
                  @csrf
                  ...
                  <div class="mb-3">
                    <label for="verificationCode" class="form-label">Mật khẩu mới </label>
                    <input type="text" class="form-control" id="verificationCode" name="newpass" required />
                  </div>
